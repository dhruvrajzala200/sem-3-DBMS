...
--2. Display your name in lower & upper case.
	SELECT UPPER('dhruvrajsinh zala'),LOWER('DHRUVRAJSINH ZALA')

--3. Display first three characters of your name.
	SELECT LEFT('DHRUVRAJSINH',3)

--4. Display 3rd to 10th character of your name.
	SELECT SUBSTRING('DHRUVRAJSINH',3,8)
...
--12. Write a query to convert a float 10.58 to integer (Use cast and convert function).
	SELECT CONVERT(decimal,'10.58')
	SELECT CAST('10.58' AS numeric)
	
--13. Put 10 space before your name using function.
	SELECT SPACE(10)+'DHRUVRAJ'

--14. Combine two strings using + sign as well as CONCAT ().
	SELECT 'DHRUVRAJSINH ' + ' JHALA'
	SELECT CONCAT('DHRUVRAJSINH ',' JHALA')

--15. Find reverse of “Darshan”.
	SELECT REVERSE('DARSHAN')

--16. Repeat your name 3 times	SELECT REPLICATE('DHRUVRAJSINH',3)--Date Functions
--Part – A:
...
--14. Calculate your age in years and months.
	SELECT DATEDIFF(YEAR,'11 JUL 2006',GETDATE()),DATEDIFF(MONTH,'11 JUL 2006',GETDATE())